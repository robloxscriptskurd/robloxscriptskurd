...
do  
	...
	then 
		clear
		BASHCHECK=$(cat ~/.bashrc | grep "/bin/kurdX")
		if [[ "$BASHCHECK" != "" ]]
		then 
...
clear
sleep 1
echo -e "Installation is finished. Type 'KurdX' to launch the script after we exit."
sleep 0.5
echo -en "Starting KurdX"; sleep 0.5 ;echo -en "." ;sleep 0.5 ;echo -en "." ;sleep 0.5 ;echo -en "." ;sleep 0.5 ;echo -en "." ;
sudo kurdX
